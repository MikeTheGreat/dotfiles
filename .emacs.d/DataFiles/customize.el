(custom-set-variables
 ...
 '(buffer-stack-filter 'buffer-stack-filter-exclusive-regexp)
 '(buffer-stack-show-position 'buffer-stack-show-position-all-buffers)
 '(buffer-stack-untracked
   '("KILL" "*Compile-Log*" "*Compile-Log-Show*" "*Group*" "*Completions*" "helm"))
 '(cua-enable-cua-keys nil t)
 '(cursor-type '(bar . 3))
 '(custom-enabled-themes '(obsidian-MikePanitz))
 '(custom-safe-themes
 ...
 '(org-agenda-files
   '("C:/MikesStuff/Pers/DropBox/Personal/OrgMode/Teaching.org" "C:/MikesStuff/Pers/DropBox/Personal/OrgMode/Personal.org" "C:/MikesStuff/Pers/DropBox/Personal/OrgMode/Union.org" "C:/MikesStuff/Pers/DropBox/Personal/OrgMode/Wait For.org") t)
...
(custom-set-faces
 ...
 '(markdown-header-face-1 ((t (:inherit markdown-header-face :foreground "goldenrod" :underline t :height 1.3))))
